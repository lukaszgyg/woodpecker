...
var migrations = []struct {
	...
	},
	{
		...
		stmt: alterTableAddDepStatusColumnToTasks,
	},
}
...
//
// 029_add_dep_status_column_to_tasks.sql
//

var alterTableAddDepStatusColumnToTasks = `
ALTER TABLE tasks ADD COLUMN task_dep_status BLOB
`
